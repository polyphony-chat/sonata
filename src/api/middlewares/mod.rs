...
/// Authentication middleware, implementing [Endpoint] via [AuthenticationMiddlewareImpl]
...
pub struct AuthenticationMiddlewareImpl<E> {
    /// I copied this from symfonia and don't know exactly what this is, but we need it, so...
    ep: E,
}
