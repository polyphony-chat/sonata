-- Fixture data for testing get_valid_token function
...
-- Test ID-Certs (only for users 1 and 2, user 3 has no cert)
INSERT INTO idcert (
...
-- User 1 has two tokens: one expired, one valid
...
-- User 2 has one valid token with longer expiration
('valid_token_hash_2', 2, '00000000-0000-0000-0000-000000000002', NOW() + INTERVAL '2 hours'),
-- User 2 has another valid token with shorter expiration (should not be selected)
