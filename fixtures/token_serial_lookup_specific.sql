...
('token_hash_user_1_b', 1, '00000000-0000-0000-0000-000000000001', NOW() + INTERVAL '2 hours'),
...
('token_hash_user_2_b', 2, '00000000-0000-0000-0000-000000000002', NOW() + INTERVAL '2 hours'),
...
('expired_token_hash_user_4', 4, '00000000-0000-0000-0000-000000000004', NOW() + INTERVAL '1 hour');
